...
int main()
{
    ...
    Account a1(c1, 100, higher_account_number(accountList), date);
    accountList.push_back(a1);
    Account a2(c2, 100, higher_account_number(accountList), temporality::Date(10, 16, 2022));
    accountList.push_back(a2);
    Account a3(c3, 100, higher_account_number(accountList), temporality::Date(10, 16, 2022));
    accountList.push_back(a3);
    Account a4(c1, 1000, higher_account_number(accountList), temporality::Date(10, 16, 2022));
    accountList.push_back(a4);
    Account a5(c4, 2000000, higher_account_number(accountList), temporality::Date(10, 17, 2022));
    ...
    accountList[4].send_money(1999999, accountList[1]);
